        ...
        <v-dialog v-model="showdialog" width="800">
            <v-card fill-height>
                ...
                <v-card-text>
                    ...
                    <v-row>
                        <v-col cols="6">
                            <v-select v-model="ebook.netconid" :items="netconids" label="数据交易查询(链上查询)" placeholder="" :readonly="getReadonly()" />
                        </v-col>
                        <v-col cols="6">
                            <v-select v-model="ebook.taxid" :items="etaxids" label="数据编号(链上查询)" placeholder="" :readonly="getReadonly()" />
                        </v-col>
                    </v-row>
                </v-card-text>
